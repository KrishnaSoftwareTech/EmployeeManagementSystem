...
public class MedicalDetailsController {
	...
	public ResponseEntity<EmpMedicalDetails> addMedicalDetails(Long sapId,EmpMedicalDetails medicalDetails){
	...
	public ResponseEntity<EmpMedicalDetails> updateMedicalDetails(Long sapId,EmpMedicalDetails medicalDetails){
		EmpMedicalDetails addMedicalInformation;
		try {
...
@DeleteMapping("/Employees/{sapId}/EmployeeInfo/medicalInfo")
	public void deleteMedicalDetails(Long sapId){
		try {
